...
function getBase64CodestonePhaserJari() {
...
class stonePhaserJari {
  ...
  async load() {
    try {
      ...
      let real_url =
        this.baseURL === ""
          ? "stonePhaserJari.wasm"
          : this.baseURL + "/stonePhaserJari.wasm";
      ...
      return new Promise((resolve, reject) => {
        ...
        let re = /JSON_STR/g;
        let stonePhaserJariProcessorString1 = stonePhaserJariProcessorString.replace(
          re,
          json
        );
        let real_url = window.URL.createObjectURL(
          new Blob([stonePhaserJariProcessorString1], {
        ...
        this.context.audioWorklet
          ...
          .then(() => {
            ...
            this.node.onprocessorerror = () => {
              console.log(
                "An error from stonePhaserJari-processor was detected."
              );
            };
            return this.node;
          })
