...
bypass = checkbox("[0] Bypass zero [symbol:bypass]");
...
fbHf = hslider("[4] Feedback_bass_cut [abbrev:Fb bass cut] [symbol:feedback_hpf_cutoff] [unit:Hz] [scale:log] [style:knob]", 500., 10., 5000., 1.) : tsmooth;
dw = hslider("[5] Drywet [symbol:mix] [unit:%] [integer] [style:knob]", 50, 0, 100, 1) : *(0.01);
